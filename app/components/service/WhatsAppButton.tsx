...
const WhatsAppButton = ({ serviceName }: WhatsAppButtonProps) => {
    const message = encodeURIComponent(`Hola, me gustaría solicitar el servicio de ${serviceName}.`);
    const whatsappUrl = `https://wa.me/${siteSettings.company.whatsapp}?text=${message}`;
    ...
    return (
        <div className="fixed bottom-8 right-8 z-50">
            ...
            >
                ...
                <span className="text-lg tracking-tight">Solicitar Ahora</span>
            </a>
        </div>
    );
};
