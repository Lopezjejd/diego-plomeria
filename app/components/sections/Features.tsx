...
const features = [
    {
        ...
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-base">
...
const Features = () => {
    return (
        <section className="py-24 bg-white dark:bg-black-dark overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <ScrollReveal animation="fade-right">
                            ...
                            <p className="text-lg text-black-light/70 dark:text-white-dark/70 mb-12 max-w-xl leading-relaxed">
                            ...
                            {features.map((feature, index) => (
                                <ScrollReveal key={index} animation="fade-up" delay={index * 150}>
                                    <div className="flex gap-6 group">
                                        <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-blue-base/5 flex items-center justify-center group-hover:bg-blue-light group-hover:text-white transition-all duration-300">
                                            {feature.icon}
                                        </div>
                                        <div>
                                            <h3 className="text-xl font-bold text-black-base dark:text-white-light mb-2">
                                                {feature.title}
                                            </h3>
                                            <p className="text-black-light/60 dark:text-white-dark/60 leading-relaxed">
                                                {feature.description}
                                            </p>
                                        </div>
                                    </div>
