...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-[90vh] sm:p-15 w-full flex items-center justify-center overflow-hidden">
            ...
            {/* CONTENT */}
            <div className="relative z-20 container mx-auto px-4 sm:px-6 flex flex-col items-center text-center max-w-7xl pt-20">
                ...
                <h1 className="text-4xl md:text-6xl  font-black text-white-light mb-8 tracking-tighter leading-[1.2] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
                ...
                <p className="text-xs md:text-2xl text-white-base/90 mb-12 max-w-2xl leading-relaxed font-medium drop-shadow-md">
                    {siteSettings.home.hero.subtitle}
                </p>


                {/* Service Cards Grid - Compact Mobile Rows, Desktop Columns */}
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 md:gap-6 w-full mb-8 md:mb-12 max-w-6xl">
                    {services.map((service) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group relative flex lg:flex-col items-center text-left lg:text-center p-3 lg:p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl lg:rounded-2xl hover:bg-white/10 transition-all duration-300 hover:scale-[1.02] lg:hover:scale-105 hover:shadow-xl hover:shadow-blue-500/10 gap-3 lg:gap-0"
                            >
                                {/* Icon */}
                                <div className="shrink-0 p-2 lg:p-3 rounded-full bg-blue-500/10 text-blue-400 group-hover:bg-blue-500 group-hover:text-white transition-all duration-300 lg:mb-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h3 className="text-sm lg:text-lg font-bold text-white mb-0.5 lg:mb-2 group-hover:text-blue-300 transition-colors truncate lg:whitespace-normal">
                                        {service.header.title.replace(/ a Domicilio/gi, "").replace(/ en Medellín/gi, "")}
                                    </h3>
                                    <p className="hidden lg:block text-xs text-white/70 leading-tight lg:leading-relaxed lg:min-h-[40px] line-clamp-1 lg:line-clamp-2">
                                        {detail?.copy}
                                    </p>
                                </div>

                                {/* Arrow (Mobile) / CTA (Desktop) */}
                                <div className="shrink-0 text-blue-400 group-hover:text-white transition-colors lg:w-full lg:mt-auto">
                                    {/* Mobile Arrow */}
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="lg:hidden transform group-hover:translate-x-1 transition-transform">
                                        <path d="m9 18 6-6-6-6" />
                                    </svg>

                                    {/* Desktop "Ver Servicio" */}
                                    <span className="hidden lg:flex items-center justify-center gap-1 text-xs font-bold uppercase tracking-widest mt-2">
                                        Ver Servicio
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="transform group-hover:translate-x-1 transition-transform">
