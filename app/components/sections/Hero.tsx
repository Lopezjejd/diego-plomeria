        ...
        <section className="relative min-h-[90vh] sm:p-15 w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 container mx-auto px-6 flex flex-col items-center text-center max-w-4xl pt-20">
                ...
                <ScrollReveal animation="fade-up" delay={600}>
                    <h1 className="text-5xl md:text-6xl  font-black text-white-light mb-8 tracking-tighter leading-[0.9] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
                ...
                <ScrollReveal animation="fade-up" delay={1000}>
                    <div className="flex items-center gap-3 text-white-base/80 drop-shadow-md">
                        <div className="flex items-center justify-center w-6 h-6 rounded-full bg-white/10 backdrop-blur-sm">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white-light">
